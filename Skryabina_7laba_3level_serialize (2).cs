...
public class Program
{
    ...
    public abstract class Serializer
    {
        ...
        public abstract void Serialize(List<Result> results, string fileName);
        public abstract List<Result> Deserialize(string fileName);
    }
    ...
    public class MyJsonSerializer : Serializer
    {
        ...
        public override List<Result> Deserialize(string fileName)
        {
            if (File.Exists(fileName))
            {
                return JsonSerializer.Deserialize<List<Result>>(File.ReadAllText(fileName));
            }
            else
            {
        ...
        public override void Serialize(List<Result> results, string fileName)
        {
            try
            {
